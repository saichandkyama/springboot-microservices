...
public class AccountsController {
    ...
    /**
     * Endpoint to retrieve the contact information for support.
     * <p>
     * Handles HTTP GET requests to provide contact details that can be used
     * in case of any issues with the accounts microservice.
     *
     * @return a ResponseEntity containing the contact information DTO
     */
